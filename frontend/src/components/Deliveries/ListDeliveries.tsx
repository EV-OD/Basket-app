...
const ListDeliveries = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_DELIVERIES');
            ...
            <CardBox hasTable key={item.id} className={'rounded'}>
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>DeliveryPersonnel</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.usersOneListFormatter(
                        item.delivery_personnel,
                      )}
                    </p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>ProofofDelivery</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.booleanFormatter(item.proof_of_delivery)}
                    </p>
                  </div>
                </div>
                <ListActionsPopover
