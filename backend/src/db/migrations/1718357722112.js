module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('subscriptions', 'consumerId', {
        transaction,
      });

      await queryInterface.removeColumn('reviews', 'rating', { transaction });

      await queryInterface.removeColumn('reviews', 'content', { transaction });

      await queryInterface.removeColumn('reviews', 'productId', {
        transaction,
      });

      await queryInterface.removeColumn('reviews', 'consumerId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('orders', 'consumerId', {
        transaction,
      });

      await queryInterface.removeColumn('deliveries', 'proof_of_delivery', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('deliveries', 'pickup_date', {
        transaction,
      });

      await queryInterface.removeColumn('deliveries', 'delivery_personnelId', {
        transaction,
      });
